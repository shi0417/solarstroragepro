// Insert "Battery Storage for EV Charging Infrastructure" blog article into Supabase
// Date: 2026-09-10

const SUPABASE_URL = 'https://qujcrmbzuzlgjrexbzga.supabase.co';
const ANON_KEY = 'sb_publishable_bBrZR2df4POLnM4sWI96xQ_xPvlD06k';

const SLUG = 'battery-storage-ev-charging-infrastructure';
const DATE = '2026-09-10';
const READ_TIME = 10;
const TAGS = ['EV Charging', 'Battery Storage', 'BESS', 'Smart Charging', 'Commercial', 'Peak Shaving'];

// ============== EN CONTENT ==============
const EN = {
  locale: 'en',
  category: 'Commercial Applications',
  title: 'Battery Storage for EV Charging Infrastructure: A Complete BESS Guide for 2026',
  ...
  body: `## Why EV Charging Infrastructure Needs Battery Storage
...
const ZH = {
  locale: 'zh',
  category: '工商业应用',
  title: '储能系统在电动汽车充电站中的应用：B2B 完整指南（2026）',
