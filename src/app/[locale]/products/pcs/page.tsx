...
const SPEC_ROWS = [
  // AC & DC parameters
  { catKey: "acDc", t: { en: { item: "Rated AC power", detail: "N × 215kW @ 45°C；N × 129kW @ 50°C（N 为模块数，20~32）" }, zh: { item: "额定交流功率", detail: "N × 215kW @ 45°C；N × 129kW @ 50°C（N 为模块数，20~32）" }, es: { item: "Potencia AC nominal", detail: "N × 215kW @ 45°C; N × 129kW @ 50°C (N = número de módulos, 20~32)" }, tr: { item: "Nominal AC gücü", detail: "N × 215kW @ 45°C; N × 129kW @ 50°C (N = modül sayısı, 20~32)" }, pt: { item: "Potência AC nominal", detail: "N × 215kW @ 45°C; N × 129kW @ 50°C (N = número de módulos, 20~32)" }, de: { item: "Nenn-AC-Leistung", detail: "N × 215kW @ 45°C; N × 129kW @ 50°C (N = Modulanzahl, 20~32)" }, fr: { item: "Puissance AC nominale", detail: "N × 215kW @ 45°C; N × 129kW @ 50°C (N = nombre de modules, 20~32)" } } },
  { catKey: "acDc", t: { en: { item: "Max AC power", detail: "110% 额定功率，2 分钟（≤ 45°C）" }, zh: { item: "最大交流功率", detail: "110% 额定功率，2 分钟（≤ 45°C）" }, es: { item: "Potencia AC máx.", detail: "110% potencia nominal, 2 min (≤ 45°C)" }, tr: { item: "Maks. AC gücü", detail: "110% nominal güç, 2 dakika (≤ 45°C)" }, pt: { item: "Potência AC máx.", detail: "110% potência nominal, 2 min (≤ 45°C)" }, de: { item: "Max. AC-Leistung", detail: "110% Nennleistung, 2 min (≤ 45°C)" }, fr: { item: "Puissance AC max.", detail: "110% puissance nominale, 2 min (≤ 45°C)" } } },
  { catKey: "acDc", t: { en: { item: "AC voltage / frequency", detail: "10kV–33kV / 50Hz" }, zh: { item: "交流电压 / 频率", detail: "10kV–33kV / 50Hz" }, es: { item: "Voltaje AC / frecuencia", detail: "10kV–33kV / 50Hz" }, tr: { item: "AC voltaj / frekans", detail: "10kV–33kV / 50Hz" }, pt: { item: "Tensão AC / frequência", detail: "10kV–33kV / 50Hz" }, de: { item: "AC-Spannung / Frequenz", detail: "10kV–33kV / 50Hz" }, fr: { item: "Tension AC / fréquence", detail: "10kV–33kV / 50Hz" } } },
  { catKey: "acDc", t: { en: { item: "DC voltage range", detail: "1000V–1500V（满载放电以 1070V 为参考下限）" }, zh: { item: "直流电压范围", detail: "1000V–1500V（满载放电以 1070V 为参考下限）" }, es: { item: "Rango de voltaje DC", detail: "1000V–1500V (referencia 1070V para descarga a plena carga)" }, tr: { item: "DC voltaj aralığı", detail: "1000V–1500V (tam yük deşarj için 1070V referans alt sınır)" }, pt: { item: "Faixa de tensão DC", detail: "1000V–1500V (referência 1070V para descarga a plena carga)" }, de: { item: "DC-Spannungsbereich", detail: "1000V–1500V (1070V Referenzuntergrenze für Volllastentladung)" }, fr: { item: "Plage de tension DC", detail: "1000V–1500V (réf. 1070V pour décharge à pleine charge)" } } },
  { catKey: "acDc", t: { en: { item: "THDi / THDu", detail: "< 3%" }, zh: { item: "THDi / THDu", detail: "< 3%" }, es: { item: "THDi / THDu", detail: "< 3%" }, tr: { item: "THDi / THDu", detail: "< %3" }, pt: { item: "THDi / THDu", detail: "< 3%" }, de: { item: "THDi / THDu", detail: "< 3%" }, fr: { item: "THDi / THDu", detail: "< 3%" } } },
  { catKey: "acDc", t: { en: { item: "Max DC current (per branch)", detail: "1612A / 201A" }, zh: { item: "最大直流电流（每支路）", detail: "1612A / 201A" }, es: { item: "Corriente DC máx. (por rama)", detail: "1612A / 201A" }, tr: { item: "Maks. DC akımı (dal başına)", detail: "1612A / 201A" }, pt: { item: "Corrente DC máx. (por ramo)", detail: "1612A / 201A" }, de: { item: "Max. DC-Strom (pro Zweig)", detail: "1612A / 201A" }, fr: { item: "Courant DC max. (par branche)", detail: "1612A / 201A" } } },
  // LV & auxiliary
  { catKey: "lv", t: { en: { item: "Auxiliary transformer", detail: "50kVA，690V / 400V" }, zh: { item: "辅助变压器", detail: "50kVA，690V / 400V" }, es: { item: "Transformador auxiliar", detail: "50kVA, 690V / 400V" }, tr: { item: "Yardımcı transformatör", detail: "50kVA, 690V / 400V" }, pt: { item: "Transformador auxiliar", detail: "50kVA, 690V / 400V" }, de: { item: "Hilfstransformator", detail: "50kVA, 690V / 400V" }, fr: { item: "Transformateur auxiliaire", detail: "50kVA, 690V / 400V" } } },
  { catKey: "lv", t: { en: { item: "UPS", detail: "2kVA（1h 标准）" }, zh: { item: "UPS", detail: "2kVA（1h 标准）" }, es: { item: "UPS", detail: "2kVA (1h estándar)" }, tr: { item: "UPS", detail: "2kVA (1 saat standart)" }, pt: { item: "UPS", detail: "2kVA (1h padrão)" }, de: { item: "USV", detail: "2kVA (1h Standard)" }, fr: { item: "UPS", detail: "2kVA (1h standard)" } } },
  { catKey: "lv", t: { en: { item: "Cooling", detail: "温控强制风冷" }, zh: { item: "冷却方式", detail: "温控强制风冷" }, es: { item: "Refrigeración", detail: "Enfriamiento forzado por aire controlado por temperatura" }, tr: { item: "Soğutma", detail: "Sıcaklık kontrollü cebri hava soğutma" }, pt: { item: "Refrigeração", detail: "Refrigeração forçada a ar com controle de temperatura" }, de: { item: "Kühlung", detail: "Temperaturgesteuerte Zwangsluftkühlung" }, fr: { item: "Refroidissement", detail: "Refroidissement à air forcé contrôlé par température" } } },
  // Transformer
  { catKey: "transformer", t: { en: { item: "Capacity", detail: "5200kVA @ 45°C 或 6900kVA @ 45°C" }, zh: { item: "容量", detail: "5200kVA @ 45°C 或 6900kVA @ 45°C" }, es: { item: "Capacidad", detail: "5200kVA @ 45°C o 6900kVA @ 45°C" }, tr: { item: "Kapasite", detail: "5200kVA @ 45°C veya 6900kVA @ 45°C" }, pt: { item: "Capacidade", detail: "5200kVA @ 45°C ou 6900kVA @ 45°C" }, de: { item: "Kapazität", detail: "5200kVA @ 45°C oder 6900kVA @ 45°C" }, fr: { item: "Capacité", detail: "5200kVA @ 45°C ou 6900kVA @ 45°C" } } },
  { catKey: "transformer", t: { en: { item: "Vector group", detail: "Dy11y11" }, zh: { item: "联结组别", detail: "Dy11y11" }, es: { item: "Grupo de conexión", detail: "Dy11y11" }, tr: { item: "Vektör grubu", detail: "Dy11y11" }, pt: { item: "Grupo vetorial", detail: "Dy11y11" }, de: { item: "Vektorgruppe", detail: "Dy11y11" }, fr: { item: "Groupe vectoriel", detail: "Dy11y11" } } },
  { catKey: "transformer", t: { en: { item: "Type / cooling", detail: "油浸式 / ONAN" }, zh: { item: "类型 / 冷却", detail: "油浸式 / ONAN" }, es: { item: "Tipo / refrigeración", detail: "Sumergido en aceite / ONAN" }, tr: { item: "Tip / soğutma", detail: "Yağlı tip / ONAN" }, pt: { item: "Tipo / refrigeração", detail: "Imerso em óleo / ONAN" }, de: { item: "Typ / Kühlung", detail: "Ölgekühlt / ONAN" }, fr: { item: "Type / refroidissement", detail: "Immergé dans l'huile / ONAN" } } },
  { catKey: "transformer", t: { en: { item: "Efficiency", detail: "Tier 2（EU548）" }, zh: { item: "效率", detail: "Tier 2（EU548）" }, es: { item: "Eficiencia", detail: "Tier 2 (EU548)" }, tr: { item: "Verimlilik", detail: "Tier 2 (EU548)" }, pt: { item: "Eficiência", detail: "Tier 2 (EU548)" }, de: { item: "Effizienz", detail: "Tier 2 (EU548)" }, fr: { item: "Efficacité", detail: "Tier 2 (EU548)" } } },
  { catKey: "transformer", t: { en: { item: "Transformer protection", detail: "压力、温度（两级）、气体继电器" }, zh: { item: "本体保护", detail: "压力、温度（两级）、气体继电器" }, es: { item: "Protección del transformador", detail: "Presión, temperatura (dos niveles), relé de gas" }, tr: { item: "Transformatör koruması", detail: "Basınç, sıcaklık (iki kademeli), gaz rölesi" }, pt: { item: "Proteção do transformador", detail: "Pressão, temperatura (dois níveis), relé de gás" }, de: { item: "Transformatorschutz", detail: "Druck, Temperatur (zweistufig), Gasrelais" }, fr: { item: "Protection du transformateur", detail: "Pression, température (deux niveaux), relais à gaz" } } },
  // Switchgear
  { catKey: "switchgear", t: { en: { item: "Switchgear configuration", detail: "DeV / CV / CCV / VMV（可定制）" }, zh: { item: "开关柜配置", detail: "DeV / CV / CCV / VMV（可定制）" }, es: { item: "Configuración del interruptor", detail: "DeV / CV / CCV / VMV (personalizable)" }, tr: { item: "Şalt konfigürasyonu", detail: "DeV / CV / CCV / VMV (özelleştirilebilir)" }, pt: { item: "Configuração do painel", detail: "DeV / CV / CCV / VMV (personalizável)" }, de: { item: "Schaltanlagenkonfiguration", detail: "DeV / CV / CCV / VMV (anpassbar)" }, fr: { item: "Configuration de l'appareillage", detail: "DeV / CV / CCV / VMV (personnalisable)" } } },
  { catKey: "switchgear", t: { en: { item: "MV switching & protection", detail: "真空断路器（VCB）、微机保护系统" }, zh: { item: "中压开关与保护", detail: "真空断路器（VCB）、微机保护系统" }, es: { item: "Conmutación y protección MV", detail: "Interruptor de circuito al vacío (VCB), sistema de protección basado en microcomputadora" }, tr: { item: "OG anahtarlama ve koruma", detail: "Vakumlu kesici (VCB), mikroişlemci koruma sistemi" }, pt: { item: "Comutação e proteção MT", detail: "Disjuntor a vácuo (VCB), sistema de proteção por microprocessador" }, de: { item: "MS-Schaltung & Schutz", detail: "Vakuum-Leistungsschalter (VCB), Mikroprozessor-Schutzsystem" }, fr: { item: "Commutation & protection MT", detail: "Disjoncteur à vide (VCB), système de protection à microprocesseur" } } },
  { catKey: "switchgear", t: { en: { item: "DC side protection", detail: "直流断路器 / 熔断器" }, zh: { item: "直流侧保护", detail: "直流断路器 / 熔断器" }, es: { item: "Protección del lado DC", detail: "Interruptor de circuito DC / fusibles" }, tr: { item: "DC tarafı koruması", detail: "DC kesici / sigortalar" }, pt: { item: "Proteção lado DC", detail: "Disjuntor DC / fusíveis" }, de: { item: "DC-seitiger Schutz", detail: "DC-Leistungsschalter / Sicherungen" }, fr: { item: "Protection côté DC", detail: "Disjoncteur DC / fusibles" } } },
  // General
  { catKey: "general", t: { en: { item: "Enclosure size (W×H×D)", detail: "40ft（12192×2896×2438 mm）或 45ft" }, zh: { item: "集装箱尺寸（W×H×D）", detail: "40ft（12192×2896×2438 mm）或 45ft" }, es: { item: "Tamaño del contenedor (W×H×D)", detail: "40ft (12192×2896×2438 mm) o 45ft" }, tr: { item: "Kabin boyutu (G×Y×D)", detail: "40ft (12192×2896×2438 mm) veya 45ft" }, pt: { item: "Dimensões do contêiner (L×A×P)", detail: "40ft (12192×2896×2438 mm) ou 45ft" }, de: { item: "Gehäuse (B×H×T)", detail: "40ft (12192×2896×2438 mm) oder 45ft" }, fr: { item: "Dimensions (L×H×P)", detail: "40ft (12192×2896×2438 mm) ou 45ft" } } },
  { catKey: "general", t: { en: { item: "Total weight", detail: "≤ 30t" }, zh: { item: "总重", detail: "≤ 30t" }, es: { item: "Peso total", detail: "≤ 30t" }, tr: { item: "Toplam ağırlık", detail: "≤ 30t" }, pt: { item: "Peso total", detail: "≤ 30t" }, de: { item: "Gesamtgewicht", detail: "≤ 30t" }, fr: { item: "Poids total", detail: "≤ 30t" } } },
  { catKey: "general", t: { en: { item: "Enclosure protection", detail: "IP54（舱体整体）" }, zh: { item: "防护等级", detail: "IP54（舱体整体）" }, es: { item: "Protección del recinto", detail: "IP54 (conjunto del contenedor)" }, tr: { item: "Kabin koruması", detail: "IP54 (tüm konteyner)" }, pt: { item: "Proteção do invólucro", detail: "IP54 (contêiner completo)" }, de: { item: "Gehäuseschutz", detail: "IP54 (gesamter Container)" }, fr: { item: "Protection du boîtier", detail: "IP54 (conteneur complet)" } } },
  { catKey: "general", t: { en: { item: "Operating temperature", detail: "-25°C 至 60°C（45°C 以上降额）" }, zh: { item: "工作温度", detail: "-25°C 至 60°C（45°C 以上降额）" }, es: { item: "Temperatura de funcionamiento", detail: "-25°C a 60°C (derating por encima de 45°C)" }, tr: { item: "Çalışma sıcaklığı", detail: "-25°C ila 60°C (45°C üzerinde güç düşümü)" }, pt: { item: "Temperatura de operação", detail: "-25°C a 60°C (derating acima de 45°C)" }, de: { item: "Betriebstemperatur", detail: "-25°C bis 60°C (Derating über 45°C)" }, fr: { item: "Température de fonctionnement", detail: "-25°C à 60°C (déclassement au-dessus de 45°C)" } } },
  { catKey: "general", t: { en: { item: "Corrosion prevention", detail: "C5（仅外部机械部件）" }, zh: { item: "防腐等级", detail: "C5（仅外部机械部件）" }, es: { item: "Grado de corrosión", detail: "C5 (solo partes mecánicas externas)" }, tr: { item: "Korozyon önleme", detail: "C5 (sadece harici mekanik parçalar)" }, pt: { item: "Prevenção de corrosão", detail: "C5 (apenas partes mecânicas externas)" }, de: { item: "Korrosionsschutz", detail: "C5 (nur externe mechanische Teile)" }, fr: { item: "Protection anticorrosion", detail: "C5 (pièces mécaniques externes uniquement)" } } },
  // Communication
  { catKey: "communication", t: { en: { item: "Interfaces", detail: "RS485, CAN, TCP/IP" }, zh: { item: "通讯方式", detail: "RS485, CAN, TCP/IP" }, es: { item: "Interfaces", detail: "RS485, CAN, TCP/IP" }, tr: { item: "Arayüzler", detail: "RS485, CAN, TCP/IP" }, pt: { item: "Interfaces", detail: "RS485, CAN, TCP/IP" }, de: { item: "Schnittstellen", detail: "RS485, CAN, TCP/IP" }, fr: { item: "Interfaces", detail: "RS485, CAN, TCP/IP" } } },
];

/** Category label translations */
const CATEGORY_LABELS: Record<string, Record<string, string>> = {
  acDc:          { en: "AC & DC parameters", zh: "交流与直流参数", es: "Parámetros AC y DC", tr: "AC ve DC parametreleri", pt: "Parâmetros AC e DC", de: "AC- & DC-Parameter", fr: "Paramètres AC et DC" },
  lv:            { en: "LV & auxiliary equipment", zh: "低压与辅助设备", es: "Equipo LV y auxiliar", tr: "AG ve yardımcı ekipman", pt: "Equipamentos BT e auxiliares", de: "NS- & Hilfsausrüstung", fr: "Équipement BT et auxiliaire" },
  transformer:   { en: "Transformer", zh: "变压器参数", es: "Transformador", tr: "Transformatör", pt: "Transformador", de: "Transformator", fr: "Transformateur" },
  switchgear:    { en: "Switchgear & protection", zh: "开关柜与保护", es: "Interruptores y protección", tr: "Şalt ve koruma", pt: "Painéis e proteção", de: "Schaltanlagen & Schutz", fr: "Appareillage & protection" },
  general:      { en: "General & environment", zh: "通用与环境参数", es: "General y entorno", tr: "Genel ve çevre", pt: "Geral e ambiente", de: "Allgemein & Umgebung", fr: "Général & environnement" },
  communication: { en: "Communication", zh: "通讯接口", es: "Comunicación", tr: "İletişim", pt: "Comunicação", de: "Kommunikation", fr: "Communication" },
};
