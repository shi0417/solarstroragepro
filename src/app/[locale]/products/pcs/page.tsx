...
const SPEC_ROWS = [
  // AC & DC parameters
  { catKey: "acDc", t: { en: { item: "Rated AC power", detail: "N × 215kW @ 45°C；N × 129kW @ 50°C（N 为模块数，20~32）" }, zh: { item: "额定交流功率", detail: "N × 215kW @ 45°C；N × 129kW @ 50°C（N 为模块数，20~32）" }, es: { item: "Potencia AC nominal", detail: "N × 215kW @ 45°C; N × 129kW @ 50°C (N = número de módulos, 20~32)" }, tr: { item: "Nominal AC gücü", detail: "N × 215kW @ 45°C; N × 129kW @ 50°C (N = modül sayısı, 20~32)" }, pt: { item: "Potência AC nominal", detail: "N × 215kW @ 45°C; N × 129kW @ 50°C (N = número de módulos, 20~32)" } } },
  { catKey: "acDc", t: { en: { item: "Max AC power", detail: "110% 额定功率，2 分钟（≤ 45°C）" }, zh: { item: "最大交流功率", detail: "110% 额定功率，2 分钟（≤ 45°C）" }, es: { item: "Potencia AC máx.", detail: "110% potencia nominal, 2 min (≤ 45°C)" }, tr: { item: "Maks. AC gücü", detail: "110% nominal güç, 2 dakika (≤ 45°C)" }, pt: { item: "Potência AC máx.", detail: "110% potência nominal, 2 min (≤ 45°C)" } } },
  { catKey: "acDc", t: { en: { item: "AC voltage / frequency", detail: "10kV–33kV / 50Hz" }, zh: { item: "交流电压 / 频率", detail: "10kV–33kV / 50Hz" }, es: { item: "Voltaje AC / frecuencia", detail: "10kV–33kV / 50Hz" }, tr: { item: "AC voltaj / frekans", detail: "10kV–33kV / 50Hz" }, pt: { item: "Tensão AC / frequência", detail: "10kV–33kV / 50Hz" } } },
  { catKey: "acDc", t: { en: { item: "DC voltage range", detail: "1000V–1500V（满载放电以 1070V 为参考下限）" }, zh: { item: "直流电压范围", detail: "1000V–1500V（满载放电以 1070V 为参考下限）" }, es: { item: "Rango de voltaje DC", detail: "1000V–1500V (referencia 1070V para descarga a plena carga)" }, tr: { item: "DC voltaj aralığı", detail: "1000V–1500V (tam yük deşarj için 1070V referans alt sınır)" }, pt: { item: "Faixa de tensão DC", detail: "1000V–1500V (referência 1070V para descarga a plena carga)" } } },
  { catKey: "acDc", t: { en: { item: "THDi / THDu", detail: "< 3%" }, zh: { item: "THDi / THDu", detail: "< 3%" }, es: { item: "THDi / THDu", detail: "< 3%" }, tr: { item: "THDi / THDu", detail: "< %3" }, pt: { item: "THDi / THDu", detail: "< 3%" } } },
  { catKey: "acDc", t: { en: { item: "Max DC current (per branch)", detail: "1612A / 201A" }, zh: { item: "最大直流电流（每支路）", detail: "1612A / 201A" }, es: { item: "Corriente DC máx. (por rama)", detail: "1612A / 201A" }, tr: { item: "Maks. DC akımı (dal başına)", detail: "1612A / 201A" }, pt: { item: "Corrente DC máx. (por ramo)", detail: "1612A / 201A" } } },
  // LV & auxiliary
  { catKey: "lv", t: { en: { item: "Auxiliary transformer", detail: "50kVA，690V / 400V" }, zh: { item: "辅助变压器", detail: "50kVA，690V / 400V" }, es: { item: "Transformador auxiliar", detail: "50kVA, 690V / 400V" }, tr: { item: "Yardımcı transformatör", detail: "50kVA, 690V / 400V" }, pt: { item: "Transformador auxiliar", detail: "50kVA, 690V / 400V" } } },
  { catKey: "lv", t: { en: { item: "UPS", detail: "2kVA（1h 标准）" }, zh: { item: "UPS", detail: "2kVA（1h 标准）" }, es: { item: "UPS", detail: "2kVA (1h estándar)" }, tr: { item: "UPS", detail: "2kVA (1 saat standart)" }, pt: { item: "UPS", detail: "2kVA (1h padrão)" } } },
  { catKey: "lv", t: { en: { item: "Cooling", detail: "温控强制风冷" }, zh: { item: "冷却方式", detail: "温控强制风冷" }, es: { item: "Refrigeración", detail: "Enfriamiento forzado por aire controlado por temperatura" }, tr: { item: "Soğutma", detail: "Sıcaklık kontrollü cebri hava soğutma" }, pt: { item: "Refrigeração", detail: "Refrigeração forçada a ar com controle de temperatura" } } },
  // Transformer
  { catKey: "transformer", t: { en: { item: "Capacity", detail: "5200kVA @ 45°C 或 6900kVA @ 45°C" }, zh: { item: "容量", detail: "5200kVA @ 45°C 或 6900kVA @ 45°C" }, es: { item: "Capacidad", detail: "5200kVA @ 45°C o 6900kVA @ 45°C" }, tr: { item: "Kapasite", detail: "5200kVA @ 45°C veya 6900kVA @ 45°C" }, pt: { item: "Capacidade", detail: "5200kVA @ 45°C ou 6900kVA @ 45°C" } } },
  { catKey: "transformer", t: { en: { item: "Vector group", detail: "Dy11y11" }, zh: { item: "联结组别", detail: "Dy11y11" }, es: { item: "Grupo de conexión", detail: "Dy11y11" }, tr: { item: "Vektör grubu", detail: "Dy11y11" }, pt: { item: "Grupo vetorial", detail: "Dy11y11" } } },
  { catKey: "transformer", t: { en: { item: "Type / cooling", detail: "油浸式 / ONAN" }, zh: { item: "类型 / 冷却", detail: "油浸式 / ONAN" }, es: { item: "Tipo / refrigeración", detail: "Sumergido en aceite / ONAN" }, tr: { item: "Tip / soğutma", detail: "Yağlı tip / ONAN" }, pt: { item: "Tipo / refrigeração", detail: "Imerso em óleo / ONAN" } } },
  { catKey: "transformer", t: { en: { item: "Efficiency", detail: "Tier 2（EU548）" }, zh: { item: "效率", detail: "Tier 2（EU548）" }, es: { item: "Eficiencia", detail: "Tier 2 (EU548)" }, tr: { item: "Verimlilik", detail: "Tier 2 (EU548)" }, pt: { item: "Eficiência", detail: "Tier 2 (EU548)" } } },
  { catKey: "transformer", t: { en: { item: "Transformer protection", detail: "压力、温度（两级）、气体继电器" }, zh: { item: "本体保护", detail: "压力、温度（两级）、气体继电器" }, es: { item: "Protección del transformador", detail: "Presión, temperatura (dos niveles), relé de gas" }, tr: { item: "Transformatör koruması", detail: "Basınç, sıcaklık (iki kademeli), gaz rölesi" }, pt: { item: "Proteção do transformador", detail: "Pressão, temperatura (dois níveis), relé de gás" } } },
  // Switchgear
  { catKey: "switchgear", t: { en: { item: "Switchgear configuration", detail: "DeV / CV / CCV / VMV（可定制）" }, zh: { item: "开关柜配置", detail: "DeV / CV / CCV / VMV（可定制）" }, es: { item: "Configuración del interruptor", detail: "DeV / CV / CCV / VMV (personalizable)" }, tr: { item: "Şalt konfigürasyonu", detail: "DeV / CV / CCV / VMV (özelleştirilebilir)" }, pt: { item: "Configuração do painel", detail: "DeV / CV / CCV / VMV (personalizável)" } } },
  { catKey: "switchgear", t: { en: { item: "MV switching & protection", detail: "真空断路器（VCB）、微机保护系统" }, zh: { item: "中压开关与保护", detail: "真空断路器（VCB）、微机保护系统" }, es: { item: "Conmutación y protección MV", detail: "Interruptor de circuito al vacío (VCB), sistema de protección basado en microcomputadora" }, tr: { item: "OG anahtarlama ve koruma", detail: "Vakumlu kesici (VCB), mikroişlemci koruma sistemi" }, pt: { item: "Comutação e proteção MT", detail: "Disjuntor a vácuo (VCB), sistema de proteção por microprocessador" } } },
  { catKey: "switchgear", t: { en: { item: "DC side protection", detail: "直流断路器 / 熔断器" }, zh: { item: "直流侧保护", detail: "直流断路器 / 熔断器" }, es: { item: "Protección del lado DC", detail: "Interruptor de circuito DC / fusibles" }, tr: { item: "DC tarafı koruması", detail: "DC kesici / sigortalar" }, pt: { item: "Proteção lado DC", detail: "Disjuntor DC / fusíveis" } } },
  // General
  { catKey: "general", t: { en: { item: "Enclosure size (W×H×D)", detail: "40ft（12192×2896×2438 mm）或 45ft" }, zh: { item: "集装箱尺寸（W×H×D）", detail: "40ft（12192×2896×2438 mm）或 45ft" }, es: { item: "Tamaño del contenedor (W×H×D)", detail: "40ft (12192×2896×2438 mm) o 45ft" }, tr: { item: "Kabin boyutu (G×Y×D)", detail: "40ft (12192×2896×2438 mm) veya 45ft" }, pt: { item: "Dimensões do contêiner (L×A×P)", detail: "40ft (12192×2896×2438 mm) ou 45ft" } } },
  { catKey: "general", t: { en: { item: "Total weight", detail: "≤ 30t" }, zh: { item: "总重", detail: "≤ 30t" }, es: { item: "Peso total", detail: "≤ 30t" }, tr: { item: "Toplam ağırlık", detail: "≤ 30t" }, pt: { item: "Peso total", detail: "≤ 30t" } } },
  { catKey: "general", t: { en: { item: "Enclosure protection", detail: "IP54（舱体整体）" }, zh: { item: "防护等级", detail: "IP54（舱体整体）" }, es: { item: "Protección del recinto", detail: "IP54 (conjunto del contenedor)" }, tr: { item: "Kabin koruması", detail: "IP54 (tüm konteyner)" }, pt: { item: "Proteção do invólucro", detail: "IP54 (contêiner completo)" } } },
  { catKey: "general", t: { en: { item: "Operating temperature", detail: "-25°C 至 60°C（45°C 以上降额）" }, zh: { item: "工作温度", detail: "-25°C 至 60°C（45°C 以上降额）" }, es: { item: "Temperatura de funcionamiento", detail: "-25°C a 60°C (derating por encima de 45°C)" }, tr: { item: "Çalışma sıcaklığı", detail: "-25°C ila 60°C (45°C üzerinde güç düşümü)" }, pt: { item: "Temperatura de operação", detail: "-25°C a 60°C (derating acima de 45°C)" } } },
  { catKey: "general", t: { en: { item: "Corrosion prevention", detail: "C5（仅外部机械部件）" }, zh: { item: "防腐等级", detail: "C5（仅外部机械部件）" }, es: { item: "Grado de corrosión", detail: "C5 (solo partes mecánicas externas)" }, tr: { item: "Korozyon önleme", detail: "C5 (sadece harici mekanik parçalar)" }, pt: { item: "Prevenção de corrosão", detail: "C5 (apenas partes mecânicas externas)" } } },
  // Communication
  { catKey: "communication", t: { en: { item: "Interfaces", detail: "RS485, CAN, TCP/IP" }, zh: { item: "通讯方式", detail: "RS485, CAN, TCP/IP" }, es: { item: "Interfaces", detail: "RS485, CAN, TCP/IP" }, tr: { item: "Arayüzler", detail: "RS485, CAN, TCP/IP" }, pt: { item: "Interfaces", detail: "RS485, CAN, TCP/IP" } } },
];

/** Category label translations */
const CATEGORY_LABELS: Record<string, Record<string, string>> = {
  acDc:          { en: "AC & DC parameters", zh: "交流与直流参数", es: "Parámetros AC y DC", tr: "AC ve DC parametreleri", pt: "Parâmetros AC e DC" },
  lv:            { en: "LV & auxiliary equipment", zh: "低压与辅助设备", es: "Equipo LV y auxiliar", tr: "AG ve yardımcı ekipman", pt: "Equipamentos BT e auxiliares" },
  transformer:   { en: "Transformer", zh: "变压器参数", es: "Transformador", tr: "Transformatör", pt: "Transformador" },
  switchgear:    { en: "Switchgear & protection", zh: "开关柜与保护", es: "Interruptores y protección", tr: "Şalt ve koruma", pt: "Painéis e proteção" },
  general:      { en: "General & environment", zh: "通用与环境参数", es: "General y entorno", tr: "Genel ve çevre", pt: "Geral e ambiente" },
  communication: { en: "Communication", zh: "通讯接口", es: "Comunicación", tr: "İletişim", pt: "Comunicação" },
};
