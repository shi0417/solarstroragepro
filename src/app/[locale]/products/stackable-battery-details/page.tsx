...
export default function StackableBatteryDetailsPage() {
  ...
  const m = messages.productsStackableBattery ?? {};
      ...
      <main>
        <section className="relative overflow-hidden border-b border-[var(--border)]">
          ...
          <div className="relative mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
            ...
            <p className="mt-4 max-w-4xl text-base leading-relaxed text-slate-300">{m.sub}</p>
          </div>
        </section>
        ...
        <section className="py-14 sm:py-20">
          <div className="mx-auto max-w-6xl space-y-10 px-4 sm:px-6">
            <div className="rounded-2xl border border-[var(--border)] bg-slate-800/80 p-6 shadow-xl shadow-black/20 backdrop-blur sm:p-8">
              <h2 className="text-xl font-bold text-solar-300 sm:text-2xl">{m.section}</h2>
              ...
              <div className="mt-8">
                <ComparisonSpecTable
                  headerRow={{ cornerLabel: m.corner, titles }}
                  rows={rows}
                  {...tableProps}
                />
              </div>
