...
export default function RootLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable}`}>
      <head>
        {/* Google Tag Manager — replaces GA + Google Ads gtag scripts */}
        <Script
          id="gtm-head"
        ...
        >
          {`
            ...
            })(window,document,'script','dataLayer','GTM-MKHQ69MQ');
          `}
        </Script>
      </head>
      <body className="font-sans antialiased">
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-MKHQ69MQ"
            height="0"
            width="0"
